const cargarTarea = (e) => {
  ...
  card.innerHTML = `<div class="card"><div class="card-body text-center"><h5 class="card-title">Tarea</h5><p class="card-text">${tarea}</p><button class="btn btn-primary">Eleminar</button></div></div>`;
